...
//          A method must be declared within a class. It is defined with the name of the method, 
        ...
        // If we try to access a local variable outside its scope, we will get this error message: 
        ...
        // A block of code may exist on its own or it can belong to an if, while or for statement. In the case of for statements, variables declared in the statement 
