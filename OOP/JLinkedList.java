...
// implement the List interface. This means that you can add items, change items, remove items 
...
// list, the element is placed into a new container and that container is linked to one of 
...
// For many cases, the ArrayList is more efficient as it is common to need access to random 
// items in the list, but the LinkedList provides several methods to do certain operations more efficiently:
