...
// assignments or statements such as if or for. In order to do more complex operations, a code block can be 
// used with curly braces. If the lambda expression needs to return a value, then the code block should have 
// a return statement.
